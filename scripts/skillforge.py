...
def main():
    ...
    p = sub.add_parser("banner", help="render the responsive SkillForge banner")
    p.add_argument("--width", type=int, default=None, help="force render width")
    ...
    if args.command == "analyze":
        ...
        from banner import main as banner_main
        sys.exit(banner_main())
